      ...
      <div class="col-md-12">
          <div class="panel panel-info">
              <div class="panel-heading">
                  <h3 class="panel-title">All Nonprofits</h3>
              </div>
                    ...
                    <a href="{{ URL::route('admin.nonprofits.create') }}"
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                <a href="{{ URL::route('admin.nonprofits.edit', array($nonProf->id)) }}"
                                class="btn btn-warning"><i class="fa fa-pencil fa-fw fa-lg"></i> Edit
                                </a>
                              </td>

                              <td>
                              <a href="{{ route('admin.nonprofits.destroy',array($nonProf->id)) }}" data-method="delete" rel="nofollow" data-confirm="Are you sure you want to delete this?" class="btn btn-danger"><i class="fa fa-trash-o fa-fw fa-lg"></i> Delete</a>                  
